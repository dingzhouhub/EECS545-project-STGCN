...
if __name__ == '__main__':
    ...
    np.savetxt("training_losses.csv", np.array(training_losses), delimiter=" ")
    np.savetxt("validation_losses.csv", np.array(validation_losses), delimiter=" ")
    np.savetxt("validation_maes.csv", np.array(validation_maes), delimiter=" ")
...
#     plt.legend('training loss','validation loss')
    ...
    #out = net(A_wave, val_input)
    #prediction = out[:,3,0]
    #np.savetxt("prediction.csv", np.array(prediction), delimiter=" ")
